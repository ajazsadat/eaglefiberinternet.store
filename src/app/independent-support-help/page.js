...
export const metadata = {
  title: 'Independent Support Help | Eagle Fiber Internet',
  description:
...
function PhoneIcon() {
  return (
    <svg className={styles.phoneIcon} viewBox="0 0 50 50" fill="currentColor" aria-hidden="true">
      ...
      <path d="M30.5 6.5c6.2 1.4 11.1 6.3 12.5 12.5M30.5 13c3.7 1 6.6 3.9 7.6 7.6M30.5 19.2c1.5.5 2.7 1.7 3.2 3.2" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        <div className={styles.cards}>
          <a href={`tel:${SITE.phoneTel}`} className={`${styles.card} ${styles.cardHuman}`}>
            <Image
